...
head(journal_data[c(7:12)], 6) |>
  kable(col.names = c("Uses euphamism", "WikiLeaks' cable", "To-From-Found", "Peer Reviewed", 
...
#| fig-cap: Articles in peer-reviewed TRIP rated journals down-playig the source of materials
#| warning: false
#| message: false
#| echo: false
journal_peer <-
