...
#| fig-cap:  Articles in peer-reviewed TRIP rated Journals apparently citing leaked classified material directly 
#| warning: false
#| message: false
#| echo: false
journal_peer <-
...
#| fig-cap: Articles in Foreign Affairs and Foreign Policy Magazines apparently citing leaked classified material
#| warning: false
#| message: false
#| echo: false
...
@fig-peergoodprac demonstrates peer-reviewed journal articles articles that either discuss the classified nature of the material, discuss the fact that the materials were leaked, or contain a "to-from-found" citation (see @sec-publications). Any one of these facets point to transparent research practices, although it is worth mentioning that none of the articles included in this analysis displayed all of these attributes.
