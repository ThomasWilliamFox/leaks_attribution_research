...
The findings of this paper and those of Darnton's suggest that if an author cannot make a strong argument justifying the necessity of using these types of materials, they are best left out of academic research [@darnton]. Moreover, if an author can make such an argument and does choose to pursue these sorts of sources, the material should be cited and verified rigorously, and used in accordance with established ethical and professional frameworks [@darnton].
