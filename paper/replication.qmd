---
title: "Replicated Figures and Table: "
subtitle: "Christopher Darnton's The Provenance Problem: Research Methods and Ethics in the Age of WikiLeaks."
author: 
  - Thomas Fox
date: today
date-format: long
...
**Paper:** Darnton, Christopher. (2022). The Provenance Problem: Research Methods and Ethics in the Age of WikiLeaks. American Political Science Review, 116(3), 1110–1125. doi:10.1017/S0003055421001374

**Replication Data:** Darnton, Christopher. (2021). “Replication Data for: The Provenance Problem: Research Methods and Ethics in the Age of WikiLeaks.” Harvard Dataverse. Dataset. https://doi.org/10.7910/DVN/SPLDTF.
...
#| message: false
#### Load data ####
raw_publication_data <- read_csv(here::here("data/raw_data/raw_data.csv"))
```
...
#| echo: false
#| message: false
#| fig-cap: Articles Using Leaked Material
#### Build Figures ####
...
leak_references |> 
  ...
  ggtitle("Articles Apparently Referencing Leaked Material Directly, 2010-2020, 
in TRIP 2011-ranked Journals (n=116)") +
  theme(plot.title = element_text(size=10)) +
  scale_fill_manual(values= c("white", "black"), labels = c("FA+FP, Code 3", "Peer Reviewed, Code 3"))+
...
#| echo: false
#| message: false
#| fig-cap: Articles Using Leaked Cables
# Graph 2 
...
cables_cited |> 
  ...
  ggtitle("Articles Apparently Referencing Leaked US Diplomatic Cables Directly (n=64),
in Peer-reviewed, TRIP 2011-Ranked Journals, 2010-2020, by Cables Cited") +
  theme(plot.title = element_text(size=10))
